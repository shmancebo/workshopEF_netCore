...
namespace Encamina.workshop.ConferenceWeb.Controllers
{
    public class SessionsController : Controller
    {
        ...
        {
            var conferenceContext = _context.Sessions.Include(s => s.Event).Include(s => s.Speaker);
        ...
        public async Task<IActionResult> Create([Bind("Title,ConferenceId,Description,Level,SpeakerId,EventId,ID")] Session session)
        {
            ...
            ViewData["EventId"] = new SelectList(_context.Events, "ID", "ID", session.EventId);
            ViewData["SpeakerId"] = new SelectList(_context.Speakers, "ID", "Bio", session.SpeakerId);
            return View(session);
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["EventId"] = new SelectList(_context.Events, "ID", "ID", session.EventId);
            ViewData["SpeakerId"] = new SelectList(_context.Speakers, "ID", "Name", session.SpeakerId);
            return View(session);
        }
